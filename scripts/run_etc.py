...
def main():
    ...
    parser.add_argument("--ZENITH_ANG", type=str, help="zenith angle", default="35.00")
    ...
    parser.add_argument("--MOON_PHASE", type=str, help="moon phase", default="0.125")
    parser.add_argument("--EXP_TIME", type=str, help="exposure time", default="900")
    parser.add_argument("--EXP_NUM", type=str, help="exposure number", default="4")
    parser.add_argument("--FIELD_ANG", type=str, help="field angle", default="0.45")
